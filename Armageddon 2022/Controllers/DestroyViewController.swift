...
class DestroyViewController: UITableViewController {
    ...
    var deletedAsteriodsArray: [NearEarthObject] = []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //let name = deletedAsteriodsArray[indexPath.row].name
       // cell.deletedAsteroidName.text = "Астероид: \(String(describing: name.slice(from: "(", to: ")"))) должен быть уничтожен"
